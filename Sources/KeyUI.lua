...
getgenv().AbyssKeySysLoaded = true
...
local function saveKey(key)
    if not fileSystemSupported or not Abyss.Storage.Remember then return false end
...
local function getLogoIcon()
    if Abyss.Appearance.Icon == DefaultLogoAsset then return getIcon("logo") end
    return Abyss.Appearance.Icon
end

local function shouldDownloadLogo()
    return Abyss.Appearance.Icon == DefaultLogoAsset
end

local function getShopIcon()
    if Abyss.Shop.Icon == "" then return getLogoIcon() end
    return Abyss.Shop.Icon
end

local function isShopEnabled()
    return Abyss.Shop.Enabled
end
...
local function enableBlur()
    if not Abyss.Options.Blur then return end
    local existing = Lighting:FindFirstChild("AbyssKeySystemBlur")
    if existing then existing:Destroy() end
    Internal.BlurEffect = Instance.new("BlurEffect")
    Internal.BlurEffect.Name = "AbyssKeySystemBlur"
...
local function fullCleanup()
    ...
    local gui3 = hui:FindFirstChild("AbyssLoadingScreen")
...
local function setupDragging(header, main)
    if not Abyss.Options.Draggable then return end
...
local function CreateDoorOverlay(parentFrame, width, height)
    ...
    leftDoor.BackgroundColor3 = Abyss.Theme.Header
    ...
    rightDoor.BackgroundColor3 = Abyss.Theme.Header
    ...
    logoImage.ImageColor3 = Abyss.Theme.Text
...
local function ShowLoadingScreen(onComplete)
    ...
    local oldGui = hui:FindFirstChild("AbyssLoadingScreen")
    if oldGui then oldGui:Destroy() end
    local oldBlur = Lighting:FindFirstChild("AbyssLoadingBlur")
    if oldBlur then oldBlur:Destroy() end

    local blurEffect = Instance.new("BlurEffect")
    blurEffect.Name = "AbyssLoadingBlur"
    blurEffect.Size = 0
    blurEffect.Parent = Lighting

    local gui = Instance.new("ScreenGui")
    gui.Name = "AbyssLoadingScreen"
    ...
    for i = 1, 4 do
        ...
        line.BackgroundColor3 = Abyss.Theme.Text
    ...
    shipBody.BackgroundColor3 = Abyss.Theme.Text
    ...
    shipPoint.BackgroundColor3 = Abyss.Theme.Text
    ...
    for i, config in ipairs(trailConfigs) do
        ...
        trail.BackgroundColor3 = Abyss.Theme.Text
    ...
    for i, name in ipairs(phaseNames) do
        ...
        indicator.Text = "○"
        indicator.TextColor3 = Abyss.Theme.Pending
        ...
        label.Text = name
        label.TextColor3 = Abyss.Theme.Pending
    ...
    local function setPhase(num)
        ...
        for i = 1, 5 do
            ...
            if i < num then
                p.indicator.Text = "●"
                TweenService:Create(p.indicator, TweenInfo.new(0.2), {TextColor3 = Abyss.Theme.Success, TextTransparency = 0}):Play()
                TweenService:Create(p.label, TweenInfo.new(0.2), {TextColor3 = Abyss.Theme.Success}):Play()
            elseif i == num then
                p.indicator.Text = "●"
                p.indicator.TextTransparency = 0
                TweenService:Create(p.indicator, TweenInfo.new(0.2), {TextColor3 = Abyss.Theme.Accent}):Play()
                TweenService:Create(p.label, TweenInfo.new(0.2), {TextColor3 = Abyss.Theme.Text}):Play()
                currentPhase = num
                ...
                p.indicator.Text = "○"
                p.indicator.TextColor3 = Abyss.Theme.Pending
                p.label.TextColor3 = Abyss.Theme.Pending
            end
        end
    end
...
function Abyss:Notify(title, message, duration, iconType)
    ...
    frame.BackgroundColor3 = Abyss.Theme.Header
    frame.BorderSizePixel = 0
    frame.Parent = notifGui
    Instance.new("UICorner", frame).CornerRadius = UDim.new(0, 4)

    local stroke = Instance.new("UIStroke", frame)
    stroke.Color = Abyss.Theme.Accent
    stroke.Thickness = 1
    ...
    progressBar.BackgroundColor3 = Abyss.Theme.Accent
    ...
    local iconMap = {
        success = {"check", Abyss.Theme.Success}, error = {"alert", Abyss.Theme.Error},
        warning = {"alert", Abyss.Theme.Warning}, shield = {"shield", Abyss.Theme.Accent},
        info = {"shield", Abyss.Theme.Accent}, key = {"key", Abyss.Theme.Accent},
        copy = {"copy", Abyss.Theme.Success}, discord = {"discord", Abyss.Theme.Discord},
        close = {"close", Abyss.Theme.Error}
    }
    ...
    if iconMap[iconType] then
        ...
        icon.ImageColor3 = Abyss.Theme.Text
    end
    ...
    titleLabel.TextColor3 = Abyss.Theme.Text
    ...
    messageLabel.TextColor3 = Abyss.Theme.TextDim
...
local function CreateChangelogPanel(parent, windowWidth, panelHeight, panelWidth, mainFrame, gap)
    ...
    panel.BackgroundColor3 = Abyss.Theme.Background
    ...
    panelStroke.Color = Abyss.Theme.Accent
    panelStroke.Thickness = 2
    panelStroke.Transparency = 1

    local panelHeader = Instance.new("Frame")
    panelHeader.Size = UDim2.new(1, 0, 0, 50)
    panelHeader.BackgroundColor3 = Abyss.Theme.Header
    ...
    panelHeaderFix.BackgroundColor3 = Abyss.Theme.Header
    ...
    panelHeaderLine.BackgroundColor3 = Abyss.Theme.Accent
    ...
    panelHeaderIcon.ImageColor3 = Abyss.Theme.Accent
    ...
    panelTitle.TextColor3 = Abyss.Theme.Text
    ...
    panelClose.ImageColor3 = Abyss.Theme.TextDim
    panelClose.ScaleType = Enum.ScaleType.Fit
    panelClose.Parent = panelHeader
    panelClose.MouseEnter:Connect(function() TweenService:Create(panelClose, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.Error}):Play() end)
    panelClose.MouseLeave:Connect(function() TweenService:Create(panelClose, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.TextDim}):Play() end)
    ...
    scrollFrame.ScrollBarImageColor3 = Abyss.Theme.Accent
    ...
    for i, update in ipairs(Abyss.Changelog) do
        ...
        versionLabel.TextColor3 = Abyss.Theme.Accent
        ...
        for j, change in ipairs(update.Changes) do
            ...
            changeLabel.TextColor3 = Abyss.Theme.TextDim
        ...
        if i < #Abyss.Changelog then
            ...
            div.BackgroundColor3 = Abyss.Theme.Divider
...
local function CreateUserInfoPanel(parent, windowWidth, panelHeight, panelWidth, mainFrame, gap, startOpen)
    ...
    avatarGlow.BackgroundColor3 = Abyss.Theme.Accent
    ...
    avatarGlowStroke.Color = Abyss.Theme.Accent
    ...
    avatarContainer.BackgroundColor3 = Abyss.Theme.Input
    ...
    welcomeLabel.TextColor3 = Abyss.Theme.Text
    ...
    divider1.BackgroundColor3 = Abyss.Theme.Divider
    ...
    executorTitle.TextColor3 = Abyss.Theme.TextDim
    ...
    executorValue.TextColor3 = Abyss.Theme.Accent
    ...
    deviceTitle.TextColor3 = Abyss.Theme.TextDim
    ...
    deviceValue.TextColor3 = Abyss.Theme.Accent
    ...
    clockIcon.ImageColor3 = Abyss.Theme.Accent
    ...
    clockTimeLabel.TextColor3 = Abyss.Theme.Accent
    ...
    clockDateLabel.TextColor3 = Abyss.Theme.TextDim
...
local function BuildCenteredUI(windowWidth, windowHeight, panelHeight, userPanelWidth, changelogPanelWidth, gap, buildContent)
    ...
    mainFrame.BackgroundColor3 = Abyss.Theme.Background
    mainFrame.BorderSizePixel = 0
    mainFrame.Parent = container
    Instance.new("UICorner", mainFrame).CornerRadius = UDim.new(0, 4)

    local mainStroke = Instance.new("UIStroke", mainFrame)
    mainStroke.Color = Abyss.Theme.Accent
...
local function BuildKeylessUI()
    local oldGui = hui:FindFirstChild("AbyssKeylessSystem")
    if oldGui then oldGui:Destroy() end
    local oldGui2 = hui:FindFirstChild("AbyssKeySystem")
    ...
    header.BackgroundColor3 = Abyss.Theme.Header
    ...
    headerFix.BackgroundColor3 = Abyss.Theme.Header
    ...
    headerLine.BackgroundColor3 = Abyss.Theme.Accent
    ...
    logo.ImageColor3 = Abyss.Theme.Text
    ...
    title.Text = Abyss.Appearance.Title
    title.TextColor3 = Abyss.Theme.Text
    ...
    closeBtn.ImageColor3 = Abyss.Theme.TextDim
    closeBtn.ScaleType = Enum.ScaleType.Fit
    closeBtn.Parent = header
    closeBtn.MouseEnter:Connect(function() TweenService:Create(closeBtn, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.Error}):Play() end)
    closeBtn.MouseLeave:Connect(function() TweenService:Create(closeBtn, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.TextDim}):Play() end)
    ...
    successBox.BackgroundColor3 = Abyss.Theme.Success
    ...
    successStroke.Color = Abyss.Theme.Success
    ...
    checkIcon.ImageColor3 = Abyss.Theme.Success
    ...
    successText.TextColor3 = Abyss.Theme.Success
    ...
    keylessText.TextColor3 = Abyss.Theme.TextDim
    ...
    divider.BackgroundColor3 = Abyss.Theme.Divider
    ...
    launchBtn.BackgroundColor3 = Abyss.Theme.Accent
    ...
    launchStroke.Color = Abyss.Theme.AccentHover
    ...
    launchIcon.ImageColor3 = Abyss.Theme.Text
    ...
    launchLabel.TextColor3 = Abyss.Theme.Text
    ...
    launchBtn.MouseEnter:Connect(function() TweenService:Create(launchBtn, TweenInfo.new(0.15), {BackgroundColor3 = Abyss.Theme.AccentHover}):Play() end)
    launchBtn.MouseLeave:Connect(function() TweenService:Create(launchBtn, TweenInfo.new(0.15), {BackgroundColor3 = Abyss.Theme.Accent}):Play() end)
    ...
    userBtn.BackgroundColor3 = Abyss.Theme.Background
    ...
    userIcon.ImageColor3 = Abyss.Theme.TextDim
    userIcon.ScaleType = Enum.ScaleType.Fit
    userIcon.Parent = userBtn
    userBtn.MouseEnter:Connect(function() TweenService:Create(userIcon, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.Accent}):Play() end)
    userBtn.MouseLeave:Connect(function() TweenService:Create(userIcon, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.TextDim}):Play() end)
    ...
    discordBtn.BackgroundColor3 = Abyss.Theme.Background
    ...
    discordIcon.ImageColor3 = Abyss.Theme.Discord
    discordIcon.ScaleType = Enum.ScaleType.Fit
    discordIcon.Parent = discordBtn
    discordBtn.MouseEnter:Connect(function() TweenService:Create(discordIcon, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.DiscordHover}):Play() end)
    discordBtn.MouseLeave:Connect(function() TweenService:Create(discordIcon, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.Discord}):Play() end)
    ...
    changelogBtn.BackgroundColor3 = Abyss.Theme.Background
    ...
    changelogIcon.ImageColor3 = Abyss.Theme.TextDim
    changelogIcon.ScaleType = Enum.ScaleType.Fit
    changelogIcon.Parent = changelogBtn
    changelogBtn.MouseEnter:Connect(function() TweenService:Create(changelogIcon, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.Text}):Play() end)
    changelogBtn.MouseLeave:Connect(function() TweenService:Create(changelogIcon, TweenInfo.new(0.15), {ImageColor3 = Abyss.Theme.TextDim}):Play() end)

    if #Abyss.Changelog == 0 then
    ...
    closeBtn.MouseButton1Click:Connect(function()
        Abyss:Notify("Goodbye", "See you next time!", 2, "close")
        ...
        if Abyss.Callbacks.OnClose then Abyss.Callbacks.OnClose() end
    end)
    ...
    launchBtn.MouseButton1Click:Connect(function()
        ...
        closeDoorsThenExit(function()
            ...
            TweenService:Create(mainStroke, TweenInfo.new(0.3), {Transparency = 1}):Play()
            task.wait(0.4) gui:Destroy()
            if not Internal.IsJunkieMode and Abyss.Callbacks.OnSuccess then Abyss.Callbacks.OnSuccess() end
        end)
    end)

    discordBtn.MouseButton1Click:Connect(function()
        if Abyss.Links.Discord ~= "" then
            Abyss:Notify("Discord", "Invite link copied!", 2, "discord")
            pcall(function() setclipboard(Abyss.Links.Discord) end)
        end
    end)
    ...
    doors.open(function()
        ...
        if #Abyss.Changelog > 0 then task.wait(0.3) ui.toggleCL(changelogIcon) end
    end)
end

local function BuildKeyUI()
    local oldGui = hui:FindFirstChild("AbyssKeySystem")
    if oldGui then oldGui:Destroy() end
    local oldGui2 = hui:FindFirstChild("AbyssKeylessSystem")
    if oldGui2 then oldGui2:Destroy() end
    ...
    local logo = Instance.new("ImageLabel")
    logo.Size = Abyss.Appearance.IconSize
    logo.Position = UDim2.new(0, padding, 0.5, 0)
    logo.AnchorPoint = Vector2.new(0, 0.5)
    logo.BackgroundTransparency = 1
    logo.Image = getLogoIcon()
    ...
    titleLabel.Position = UDim2.new(0, padding + Abyss.Appearance.IconSize.X.Offset + 10, 0, 0)
    titleLabel.BackgroundTransparency = 1
    titleLabel.Text = Abyss.Appearance.Title
    titleLabel.TextColor3 = Abyss.Theme.Text
    ...
    statusFrame.BackgroundColor3 = Abyss.Theme.Input
    ...
    statusStroke.Color = Abyss.Theme.Accent
    ...
    statusIcon.ImageColor3 = Abyss.Theme.StatusIdle
    ...
    statusLabel.Text = Abyss.Appearance.Subtitle
    statusLabel.TextColor3 = Abyss.Theme.StatusIdle
    ...
    inputFrame.BackgroundColor3 = Abyss.Theme.Input
    ...
    inputStroke.Color = Abyss.Theme.Accent
    ...
    textBox.Text = ""
    textBox.TextColor3 = Abyss.Theme.Text
    textBox.PlaceholderText = "Enter your key..."
    textBox.PlaceholderColor3 = Abyss.Theme.TextDim
    ...
    dividerLine.BackgroundColor3 = Abyss.Theme.Divider
    ...
    local function createButton(text, iconKey, isPrimary, yPos)
        ...
        btn.BackgroundColor3 = isPrimary and Abyss.Theme.Accent or Abyss.Theme.Input
        ...
        btnStroke.Color = isPrimary and Abyss.Theme.AccentHover or Abyss.Theme.Accent
        ...
        iconImg.ImageColor3 = Abyss.Theme.Text
        ...
        label.BackgroundTransparency = 1
        label.Text = text
        label.TextColor3 = Abyss.Theme.Text
        ...
        local hoverColor = isPrimary and Abyss.Theme.AccentHover or Abyss.Theme.Accent
    ...
    if showShop then
        ...
        shopDivider.BackgroundColor3 = Abyss.Theme.Accent
        ...
        shopFrame.BackgroundColor3 = Abyss.Theme.Header
        ...
        shopTopFix.BackgroundColor3 = Abyss.Theme.Header
        ...
        shopIconWrapper.BackgroundColor3 = Abyss.Theme.Accent
        ...
        shopIconStroke.Color = Abyss.Theme.Accent
        ...
        shopIconImg.ImageColor3 = Abyss.Theme.Text
        ...
        shopTitle.Text = Abyss.Shop.Title
        shopTitle.TextColor3 = Abyss.Theme.Text
        ...
        shopSubtitle.Text = Abyss.Shop.Subtitle
        shopSubtitle.TextColor3 = Abyss.Theme.TextDim
        ...
        buyBtn.BackgroundColor3 = Abyss.Theme.Accent
        ...
        buyBtnStroke.Color = Abyss.Theme.AccentHover
        ...
        buyIcon.ImageColor3 = Abyss.Theme.Text
        ...
        buyLabel.Text = Abyss.Shop.ButtonText
        buyLabel.TextColor3 = Abyss.Theme.Text
        buyLabel.TextSize = mobile and 11 or 12
        buyLabel.Font = Enum.Font.ArimoBold
        buyLabel.LayoutOrder = 2
        buyLabel.Parent = buyContent

        buyBtn.MouseEnter:Connect(function() TweenService:Create(buyBtn, TweenInfo.new(0.15), {BackgroundColor3 = Abyss.Theme.AccentHover}):Play() end)
        buyBtn.MouseLeave:Connect(function() TweenService:Create(buyBtn, TweenInfo.new(0.15), {BackgroundColor3 = Abyss.Theme.Accent}):Play() end)
        buyBtn.MouseButton1Click:Connect(function()
            if Abyss.Shop.Link ~= "" then
                pcall(function() setclipboard(Abyss.Shop.Link) end)
                Abyss:Notify("Shop", "Shop link copied to clipboard!", 2, "copy")
            end
        end)
    end
    ...
    local function setStatus(state, customText)
        ...
        local color, icon, text = Abyss.Theme.StatusIdle, getIcon("lock"), customText or "No key detected"
        if state == "verifying" then
            color, icon, text = Abyss.Theme.Accent, getIcon("loading"), "Verifying key"
        ...
        elseif state == "success" then color, icon, text = Abyss.Theme.Success, getIcon("check"), customText or "Access Granted"
        elseif state == "error" then color, icon, text = Abyss.Theme.Error, getIcon("alert"), customText or "Invalid Key" end
    ...
    local function handleRedeem()
        ...
        if key == "" then Abyss:Notify("Error", "Please enter your key", 3, "warning") return end
        ...
        if valid then
            ...
            setStatus("error", errorMsg) Abyss:Notify("Invalid", errorMsg, 4, "error")
            if Abyss.Callbacks.OnFail then Abyss.Callbacks.OnFail(errorMsg) end
        end
    end

    redeemBtn.MouseButton1Click:Connect(handleRedeem)
    acquireBtn.MouseButton1Click:Connect(function()
        if Abyss.Links.GetKey ~= "" then Abyss:Notify("Copied", "Key link copied!", 3, "copy") pcall(function() setclipboard(Abyss.Links.GetKey) end)
        else Abyss:Notify("Error", "No key link set", 3, "warning") end
    end)
    discordBtn.MouseButton1Click:Connect(function()
        if Abyss.Links.Discord ~= "" then Abyss:Notify("Discord", "Invite link copied!", 2, "discord") pcall(function() setclipboard(Abyss.Links.Discord) end) end
    end)
...
function Abyss:Launch()
    Internal.IsJunkieMode = false
    Internal.ValidateFunction = Abyss.Callbacks.OnVerify
    ...
    EnsureIconsReady(function()
        ...
        if Abyss.Storage.AutoLoad and Internal.ValidateFunction then
            local savedKey = loadKey()
            if savedKey and savedKey ~= "" then
                Abyss:Notify("Checking", "Validating saved key...", 2, "shield") task.wait(0.5)
                if validateKey(savedKey, Internal.ValidateFunction) then
                    getgenv().SCRIPT_KEY = savedKey
                    Abyss:Notify("Welcome Back", "Key validated!", 2, "success")
                    if Abyss.Callbacks.OnSuccess then Abyss.Callbacks.OnSuccess() end return
                else clearKey() Abyss:Notify("Expired", "Saved key is no longer valid", 3, "warning") task.wait(1) end
            end
        end
        BuildKeyUI()
        while not getgenv().SCRIPT_KEY do task.wait(0.1) end
...
function Abyss:LaunchJunkie(config)
    ...
    EnsureIconsReady(function()
        ...
        if Abyss.Links.GetKey == "" then pcall(function() Abyss.Links.GetKey = Junkie.get_key_link() end) end
        Internal.ValidateFunction = function(key) return Junkie.check_key(key) end
        if Abyss.Options.Keyless == nil then
        ...
        elseif Abyss.Options.Keyless == true then
            if Abyss.Options.KeylessUI == false then handleKeylessSkip() return end
            BuildKeylessUI()
            while not getgenv().SCRIPT_KEY do task.wait(0.1) end
            return
        end
        if Abyss.Storage.AutoLoad then
            local savedKey = loadKey()
            if savedKey and savedKey ~= "" then
                Abyss:Notify("Checking", "Validating saved key...", 2, "shield") task.wait(0.5)
...
function Abyss:GetSavedKey() return loadKey() end
function Abyss:ClearSavedKey() return clearKey() end
